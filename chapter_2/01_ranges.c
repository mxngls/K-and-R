...
int main() {
     ...
     * not too complicated once one understands that we simply need to apply
     * type casting to set and convert between types
     *
    ...
    printf("%-10s: %20d ~ %20u\n", "Characters", 0, ((unsigned char)~0));
    printf("%-10s: %20d ~ %20u\n", "Shorts", 0, ((unsigned short)~0));
    printf("%-10s: %20d ~ %20u\n", "Integers", 0, ((unsigned int)~0));
    printf("%-10s: %20d ~ %20lu\n", "Longs", 1, ((unsigned long)~0));
