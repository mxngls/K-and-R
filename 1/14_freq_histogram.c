...
/*
 * We limit the number of characters to the ASCII standard of 95
 * *printable* characters (code points 32 until 126)
 */
 ...
 * frequencies of pdifferent characters in its input.int
 */
int main() {
    int c;
