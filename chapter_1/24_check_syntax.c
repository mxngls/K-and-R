...
/*
 * TODO: As indicated in the answer book, it might be better to not
 * check if the result of the application of the modulus operator with
 * the factor two is zero, but instead simply increment and decrement
 * the values for parentheses, etc. In doing so, while additionally
 * keeping track of the current line and column number, we could print
 * more detailed error messages that indicate where exactly an unmatched
 * number of braces occurred.
 */
